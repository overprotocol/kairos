...
type Backend interface {
	...
	StateAndHeaderByNumber(ctx context.Context, number rpc.BlockNumber, withoutCkpt bool) (*state.StateDB, *types.Header, error)
	StateAndHeaderByNumberOrHash(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash, withoutCkpt bool) (*state.StateDB, *types.Header, error)
	...
	CalcEpoch(number uint64) (uint32, error)
