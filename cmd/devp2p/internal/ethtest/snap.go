...
func (s *Suite) TestSnapGetAccountRange(t *utesting.T) {
	...
	tests := []accRangeTest{
		// Tests decreasing the number of bytes
		{
			...
			expAccounts:  66,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x6a5e43139d88da6cfba857e458ae0b5359c3fde36e362b6e5f782a90ce351f14"),
		...
		},
		{
			...
			expAccounts:  49,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x55cab9586acb40e66f66147ff3a059cfcbbad785dddd5c0cc31cb43edf98a5d5"),
		...
		},
		{
			...
			expAccounts:  33,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x3bd1c6c0fa4734af683c9740f0b73bc7163825b1c6e1415bd6ae1244c3b294ab"),
...
server to return no data because genesis is older than 127 blocks.`,
...

		{
			...
			expAccounts:  66,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x887e6e4c23e7a93a0c66f56b8ac9b5399d205063604ff2f093c5b2d30af481e3"),
...
The server should reject the request.`,
...

		{
			...
			expHashes: []common.Hash{
				...
				common.HexToHash("0xe18c37f861fe95259bfe96ca4d16757aee21b7ef0568be1c173f5ab65b94864f"),
				common.HexToHash("0xf869d8b3bddea3b402eaf864c6ea30294eed45552c89cea061e14135133ecfb4"),
