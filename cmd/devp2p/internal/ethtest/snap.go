...
func (s *Suite) TestSnapGetAccountRange(t *utesting.T) {
	...
	tests := []accRangeTest{
		// Tests decreasing the number of bytes
		{
			...
			expAccounts:  67,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x61d1f58e4f06da3877364617ccb71b57030853b3ac1574a2afbef93d5f07e8c3"),
		...
		},
		{
			...
			expAccounts:  50,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x4fe587ff9242b8400ba2270ffb2844dee757cd7c6df7c5e4404e9ce7461f727e"),
		...
		},
		{
			...
			expAccounts:  35,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x33984d5306a64f474f5bbe9acb712f7b514d13d1a51893b96b30f03a7f5523c3"),
...
The server should return the first available account of the state as the first item.`,
		},
		{
			...
			expAccounts:  67,
			expFirst:     secondKey,
			expLast:      common.HexToHash("0x61eff9f0ac2f0d1ca98bcf28f906ced130eb84b36d58c417fc7933bf9fea801d"),
...
The server should reject the request.`,
...

		{
			...
			expHashes: []common.Hash{
				...
				common.HexToHash("0x816695ea0065a944013dcd0728ac8227b92dd39126623eff379094cd8f4c1746"),
				common.HexToHash("0xdcd325be87fd78a9f5ad78fb21c1b0ee96316df7b323163fc47849c1a191909f"),
