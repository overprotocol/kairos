...
func (s *Suite) TestSnapGetAccountRange(t *utesting.T) {
	...
	tests := []accRangeTest{
		// Tests decreasing the number of bytes
		{
			...
			expAccounts:  69,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x64bfba8a4688bdee41c4b998e101567b8b56fea53d30ab85393f2d5b70c5da90"),
		...
		},
		{
			...
			expAccounts:  51,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x529525da9c1b4df0a5955af20ceb21ba6c11431a6d8a48dabdd0edb19b5ff5e6"),
		...
		},
		{
			...
			expAccounts:  34,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x37d65eaa92c6bc4c13a5ec45527f0c18ea8932588728769ec7aecfe6d9f32e42"),
...
server to return no data because genesis is older than 127 blocks.`,
...

		{
			...
			expAccounts:  69,
			expFirst:     firstKey,
			expLast:      common.HexToHash("0x7d3eeccfd59fb913b7c1da576a38811506589cb0c082898306ac97727104a41d"),
...
The server should reject the request.`,
...

		{
			...
			expHashes: []common.Hash{
				...
				common.HexToHash("0x04daadb8110d933dc4b13719320728153f07b8f2c634d788cb18fab7f50cfeb5"),
				common.HexToHash("0x10e849ec9493a55bbaed7f5de3560878ea89347585736aaef269cf0c21333b93"),
