...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			...
			[]testcase{
				{0, 0, ID{Hash: checksumToBytes(0xb29d5a94), Next: 1724720640}},
			},
		},
	}
...
func TestValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{&legacyConfig, 0, 0, ID{Hash: checksumToBytes(0xb29d5a94), Next: 0}, nil},

		{&legacyConfig, 0, 0, ID{Hash: checksumToBytes(0xb29d5a94), Next: math.MaxUint64}, nil},
	}
